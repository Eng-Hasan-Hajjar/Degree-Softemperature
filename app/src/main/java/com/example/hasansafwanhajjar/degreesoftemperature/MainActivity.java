package com.example.hasansafwanhajjar.degreesoftemperature;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mForecastAdapter = new ArrayAdapter<String> (this, R.layout.list_item_forecast, R.id.list_item_forecast_textview,new ArrayList<String>());
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]>     {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
               ...
               //  Log.v(LOG_TAG, "Built URI" + createURL(params[0]).toString());
                //above for select from the first param in prototype parameters

                URL url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?id=170063&mode=json&units=metric&cnt=7&appid=776dedb6f686cf859ad2b7d4f4743bee");
        ...
        private String[] getWeatherDateFromJson(String forecastJsonStr, int numDays)   throws JSONException {
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                resultStrs[i] = day + " *hasan* " + description + " *hajjar* " + highAndLow;
            }
